...
- 🛡️ CASH PRESERVATION (THE GOLDEN RULE): Cash is a valid position. If the broader market is bearish or choppy, YOU MUST DO NOTHING. Sitting in 100% cash during a market drop is how you win. Never force a trade. You are only permitted to execute a Buy order if ALL of the following conditions are met:
  1. The MACD momentum is explicitly Bullish.
  2. The stock price is above the EMA-20.
  3. The QQQ_Macro_Trend is BULLISH (Safe to Buy). Do NOT buy anything if the macro market is dropping.
  4. The RVOL_Percentage is > 100% (indicating strong relative buying volume, avoiding fakeouts).
  5. Your expected profit mathematically clears the friction threshold. 
  If any of these conditions fail, stay in cash.
