...
- 🔒 PROTECT WINNERS (HIGHEST PRIORITY — DO THIS FIRST EVERY SESSION):
  ...
  2. For ANY position with unrealized profit > 1% OR > $100, you MUST place a protective stop using `place_trailing_stop(symbol, stop_price)`.
  ...
  5. NEVER leave a position with >$100 unrealized profit unprotected. Lock in the green!
